...
ActiveRecord::Schema.define(version: 2021_05_03_014509) do
  ...
  create_table "bookmarks", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.index ["technique_id"], name: "index_bookmarks_on_technique_id"
    t.index ["user_id", "technique_id"], name: "index_bookmarks_on_user_id_and_technique_id", unique: true
  ...
  create_table "comments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["technique_id"], name: "index_comments_on_technique_id"
  ...
  create_table "tagmaps", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.index ["technique_id"], name: "index_tagmaps_on_technique_id"
  end
  ...
  create_table "techniques", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "title"
    t.text "body"
  ...
  create_table "weapons", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  add_foreign_key "bookmarks", "techniques"
  add_foreign_key "bookmarks", "users"
  add_foreign_key "comments", "techniques"
  ...
  add_foreign_key "tagmaps", "techniques"
